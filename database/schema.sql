...
INSERT INTO `willyfog_db`.`oauth_client` (`client_id`, `client_secret`, `redirect_uri`, `grant_types`, `scope`, `user_id`, `deleted_at`, `created_at`, `updated_at`) VALUES ('javascriptclient', '', 'cb', 'implicit', NULL, NULL, NULL, DEFAULT, DEFAULT);
